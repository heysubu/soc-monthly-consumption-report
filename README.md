# 📊 SOC Monthly Consumption Report Template
...
**[Access SOC Monthly Consumption Report](https://1drv.ms/x/c/3b61701caabf1310/IQALuUqD100PSb8BfeStpiLMAdIrnqcejlqWVxAMEYtwyW0?e=VegRut)**
...
<img width="1277" height="863" alt="Summary" src="https://github.com/user-attachments/assets/980a939f-378c-42fc-b439-a2d501f76312" />
...
3. File is password protected (Password: 123)

**Step 2: Set Monthly Details**
1. Go to "Summary" sheet
2. Change **Date** (cell in SheetTool)
3. Change **Company Name** (cell in SheetTool)
4. All sheets automatically update with new date/company

**Step 3: Enter Daily Data**
1. Open each consumption sheet:
...
2. Enter readings/usage in yellow cells only
3. All calculations are automatic

**Step 4: View Summary**
1. Go to "Summary" sheet
2. See all calculations automatically updated
...
```
1. MONTH START
   ├─ Set date in SheetTool
   └─ Set company name

2. DAILY ENTRY (Throughout month)
   ├─ Security guard logs attendance
   ├─ Housekeeping staff logs attendance
   ├─ Reception logs meter readings
   ├─ Facility manager logs consumption
   └─ Vendors log deliveries

3. MONTH END
   ├─ Review Summary sheet
   ├─ Check all calculations
   ├─ Export to PDF
   └─ Archive & copy for next month
...
ELECTRICITY & DG:
├─ Inside Meter - UPS Room: 1,078.00 KWH
├─ Inside Meter - AHU Room: 7,947.60 HVAC
├─ Outside Meter - MSEB EB: 6,940.00 KWH
├─ Outside Meter - DG: 80.00 KWH
└─ Building Meter: 89,894.00 KWH

CONSUMABLES SUMMARY:
├─ Bisleri Water: 20 units | Cost: ₹915.28
├─ Medical Items: 119 units | Cost: ₹3,263.99
├─ Stationery: 1,544 items | Cost: ₹16,382.12
├─ HK Material: 1,984 units | Cost: ₹51,402.50
├─ Food Orders: 0 orders | Cost: ₹0
├─ Veebha Coffee: 164 units | Cost: ₹24,960.00
├─ Sumant Coffee: 3,153 units | Cost: ₹19,120.56
├─ Toner: 10 cartridges | Cost: ₹6,000.00
├─ Water: 259 jars | Cost: ₹9,065.00
├─ Gallant SG: 4 guards | Cost: ₹34,721.87
├─ OOPL SG: 8 guards | Cost: ₹88,091.67
└─ Imperial HK: 12 staff | Cost: ₹113,108.17

TOTAL MONTHLY CONSUMPTION: ₹366,411.96
```
...
1. Go to relevant sheet (Stationery, HK Material, etc.)
2. Add new row with:
   - Item name
   - Vendor
   - Units
   - Rate
3. Summary automatically includes it
...
### Multiple Companies:
1. Copy entire file
2. Rename file for new company
3. Change company name in SheetTool
4. Change date
...
```
Manager sees stationery costs ₹16,382 (highest expense)
Reviews consumption - finds excessive ordering
Reduces order quantity by 20%
Next month stationery costs: ₹13,100 (20% reduction)
Annual savings: ₹39,384
```
...
Saves ₹30,000+ monthly
```

**Scenario 3: Attendance & Payroll**
```
Security attendance tracked automatically
Gallant SG: 4 guards, ₹34,721.87 total
OOPL SG: 8 guards, ₹88,091.67 total
Imperial HK: 12 staff, ₹113,108.17 total
Total manpower cost: ₹235,921.71
...
A: Go to "Inside Meter" or "OutSide Meter" → Enter opening & closing readings in yellow cells → All calculations automatic

**Q: How to add new employee?**
A: Go to attendance sheet (Gallant SG, OOPL SG, Imperial HK) → Add row with name & designation → Per-day salary calculates automatically

**Q: How to change monthly date?**
A: Go to SheetTool → Change date in yellow cell → All sheets update automatically

**Q: Can I protect individual sheets?**
A: Yes, password is 123 → Right-click sheet → Protect sheet
...
![Template](https://img.shields.io/badge/Template-Multi--Sheet-blue)
![Facility](https://img.shields.io/badge/Facility-Management-orange)
![Tracking](https://img.shields.io/badge/Tracking-Automated-green)
![Status](https://img.shields.io/badge/Status-Active-brightgreen)

---

**📊 Track Everything - Manage All Consumptions - Control Costs - Easy Reporting**
